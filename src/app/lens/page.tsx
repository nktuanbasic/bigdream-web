...
export default function LensPage() {
  ...
  return (
    <div className="min-h-screen bg-obsidian-deep text-on-surface overflow-hidden relative selection:bg-primary/30 flex flex-col">
      {/* Cinematic Lighting */}
      ...
      <main className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-8 py-16 flex-1 flex flex-col items-center justify-center">
        ...
        <div className="text-center mb-12 space-y-4 relative w-full max-w-3xl">
          ...
          <p className="text-on-surface-variant text-lg sm:text-xl font-light max-w-2xl mx-auto leading-relaxed">
          ...
          {!resultReady ? (
            <div 
              ...
              className={`relative group cursor-pointer w-full aspect-[4/3] sm:aspect-[21/9] rounded-3xl flex flex-col items-center justify-center border-2 border-dashed transition-all duration-500 overflow-hidden ${
                isDragging 
                ? 'border-primary bg-primary/5 shadow-[0_0_50px_rgba(242,202,80,0.15)] scale-[1.01]' 
                : 'border-white/10 bg-charcoal-surface/40 hover:border-white/30 hover:bg-charcoal-surface/60 backdrop-blur-xl'
              }`}
            >
              <input 
                type="file" 
              ...
              <div className="absolute top-6 left-6 w-8 h-8 border-t-2 border-l-2 border-white/20 group-hover:border-primary transition-colors duration-500" />
              <div className="absolute top-6 right-6 w-8 h-8 border-t-2 border-r-2 border-white/20 group-hover:border-primary transition-colors duration-500" />
              <div className="absolute bottom-6 left-6 w-8 h-8 border-b-2 border-l-2 border-white/20 group-hover:border-primary transition-colors duration-500" />
              <div className="absolute bottom-6 right-6 w-8 h-8 border-b-2 border-r-2 border-white/20 group-hover:border-primary transition-colors duration-500" />
              ...
              {isAnalyzing ? (
                <div className="flex flex-col items-center space-y-6 z-10">
                  <div className="relative w-24 h-24 flex items-center justify-center">
                    ...
                    <Crosshair className="text-3xl text-primary animate-pulse" />
                  </div>
                  <div className="text-center space-y-2">
                    <h3 className="text-2xl text-white font-medium" style={{ fontFamily: 'var(--font-bodoni)' }}>Isolating Features</h3>
                    <p className="text-on-surface-variant uppercase tracking-[0.15em] text-sm animate-pulse">Running tensor analysis...</p>
                  </div>
                </div>
              ) : (
                <div className="flex flex-col items-center space-y-4 z-10 transition-transform duration-500 group-hover:-translate-y-2">
                  <div className="w-20 h-20 rounded-full glass-panel flex items-center justify-center text-primary group-hover:scale-110 transition-transform duration-500 shadow-xl">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-on-surface-variant">Drag & drop matrix or click to browse</p>
                  </div>
              ...
              {/* Hover Scanline */}
              <div className="absolute left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-primary/50 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-[scan_3s_ease-in-out_infinite]" style={{ top: '50%' }} />
            </div>
          ) : (
            /* Results View */
            <div className="w-full animate-[fadeIn_0.8s_ease-out]">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 border-b border-white/10 pb-4 gap-4">
                ...
                <button 
                  ...
                  className="px-6 py-2 rounded-full glass-panel hover:bg-white/5 transition-colors text-sm uppercase tracking-wider text-on-surface-variant hover:text-primary cursor-pointer"
                >
                  New Analysis
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-6">
                  <div className="aspect-[4/5] rounded-2xl glass-panel relative overflow-hidden group inner-glow flex items-center justify-center">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-tr from-surface to-surface-container flex flex-col items-center justify-center text-white/20">
                    ...
                    <div className={`absolute top-1/4 left-1/3 w-16 h-16 border border-primary/50 bg-primary/10 flex items-center justify-center before:content-[""] before:absolute before:w-full before:h-[1px] before:bg-primary/30 before:-left-full after:content-[""] after:absolute after:h-full after:w-[1px] after:bg-primary/30 after:-bottom-full pointer-events-none group-hover:scale-110 transition-transform`}>
                      <Crosshair className="text-primary opacity-70" />
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:col-span-7 space-y-6">
                  ...
                  <div className="glass-panel rounded-2xl p-6 sm:p-8 relative overflow-hidden">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {['Brutalism', 'Neo-Futuristic', 'High Contrast', 'Minimalist Core'].map((tag, i) => (
                        <span key={tag} className="px-4 py-2 rounded-lg bg-charcoal-surface border border-white/5 text-on-surface-variant flex items-center gap-2 hover:border-primary/30 transition-colors cursor-default">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="glass-panel rounded-2xl p-6 hover:border-primary/30 transition-colors">
                      ...
                      <p className="text-sm text-on-surface-variant">Reflectivity: 0.15 | Roughness: 0.8</p>
                    </div>
                    ...
                    <div className="glass-panel rounded-2xl p-6 hover:border-primary/30 transition-colors">
                      ...
                      <p className="text-sm text-on-surface-variant">Transmission: 0.85 | IOR: 1.5</p>
                    </div>
                  </div>
                  ...
                  {/* Prompt Output */}
                  <div className="glass-panel rounded-2xl p-6 sm:p-8 border-primary/20 hover:border-primary/50 transition-colors">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button className="text-xs uppercase tracking-widest text-primary hover:text-white transition-colors border border-primary/30 px-3 py-1.5 rounded-md hover:bg-primary/20 cursor-pointer">
                        Copy Vector
                      </button>
                    </div>
                    <div className="bg-obsidian-deep p-5 rounded-xl border border-white/5 font-mono text-sm leading-relaxed text-on-surface-variant select-all cursor-text">
                      <span className="text-primary">/imagine prompt:</span> architectural photography, brutalist neo-futuristic structure, polished concrete primary, dark tinted glass secondary, sharp geometric angles, minimalist core, high contrast lighting, cinematic obsidian shadows, warm accents --ar 16:9 --v 6.0
                    </div>
                  </div>
